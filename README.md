...
Este repositorio contiene la documentación, material teórico, resúmenes y Trabajos Prácticos desarrollados durante el cursado de la materia.
...
[`DocumentacionGeneral/EstructuraRepositorio.md`](DocumentacionGeneral/EstructuraRepositorio.md)

## Gestión de Configuración

La Gestión de Configuración del repositorio incluye la identificación y organización de los Ítems de Configuración, las reglas de nombrado y los criterios utilizados para establecer Líneas Base.

Esta información se encuentra documentada en:
